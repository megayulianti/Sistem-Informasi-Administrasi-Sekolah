...
<head>
  ...
  <title>RuangAdmin - Login Tata Usaha</title>
  ...
  align-items: center;
    ...
    /* Memperbesar dan merapikan tombol login */
    .btn-primary {
    ...
    /* Memperpanjang dan merapikan form input */
    .form-group {
              ...
              <div class="col-lg-12">
                <div class="login-form bg-gradient-login">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Login Tata Usaha</h1>
                  </div>
