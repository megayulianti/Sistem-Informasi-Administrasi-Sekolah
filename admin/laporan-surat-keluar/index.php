  ...
  <div class="card">
    <div class="card-header">
     ...
     <!-- Form Filter Bulan & Tahun -->
      ...
      <!-- Form Cetak PDF -->
      <form action="laporan-surat-keluar/laporan_surat_keluar.php" method="post" target="_blank">
        <div class="row g-2">
          <div class="col-md-4">
            <select class="form-control" name="bln">
              <option value="all" selected>ALL</option>
        ...
        <table id="dataTable" class="table table-bordered table-hover align-middle text-center">
          ...
          <tbody>
            ...
            if (isset($_POST['tampilkan'])) {
              ...
              if ($bln == 'all') {
                $sql = $koneksi->query("SELECT * FROM surat_keluar WHERE YEAR(tanggal_keluar) = '$thn'");
              } else {
                $sql = $koneksi->query("SELECT * FROM surat_keluar WHERE MONTH(tanggal_keluar) = '$bln' AND YEAR(tanggal_keluar) = '$thn'");
              }
            } else {
              $sql = $koneksi->query("SELECT * FROM surat_keluar");
            }
