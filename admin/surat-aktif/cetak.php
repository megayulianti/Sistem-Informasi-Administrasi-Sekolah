...
<body onload="window.print()">
  ...
  <div class="kop">
    ...
    <div class="kop-teks">
      ...
      <p>NPSN: 10305565 | Alamat: Jl. Raya Pariaman - Tiku KM 18, Koto Tinggi Kuranji Hilir, Kec. Sungai Limau, Kab. Padang Pariaman</p>
    </div>
  </div>

  <h3 style="text-align: center;"><u>SURAT KETERANGAN AKTIF</u></h3>
  <p style="text-align: center;">Nomor:<?= $data['nomor_surat'] ?><?= date('Y') ?></p>
