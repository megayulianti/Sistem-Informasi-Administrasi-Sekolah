...
// Query data surat masuk berdasarkan bulan dan tahun
$query = "SELECT * FROM surat_masuk WHERE YEAR(tgl_surat) = '$thn'";
if ($bln !== 'all') {
    $query .= " AND MONTH(tgl_surat) = '$bln'";
}
...
<h3 style="text-align:center;">LAPORAN DATA SURAT MASUK</h3>
